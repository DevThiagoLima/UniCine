...
exports.IngressosComponent = void 0;
const core_1 = require("@angular/core");
const api_service_1 = require("../../services/api.service");
const common_1 = require("@angular/common");
const card_1 = require("@angular/material/card");
let IngressosComponent = (() => {
  ...
  `,
    ...
    let _classThis;
    var IngressosComponent = _classThis = class {
        constructor() {
        ...
        refresh() { this.api.ingressos.list().subscribe((l) => this.list = l.value ?? l); }
        ngOnDestroy() { window.removeEventListener('ingressos:changed', this.onChanged); }
    };
    __setFunctionName(_classThis, "IngressosComponent");
    (() => {
        const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
        __esDecorate(null, _classDescriptor = { value: _classThis }, _classDecorators, { kind: "class", name: _classThis.name, metadata: _metadata }, null, _classExtraInitializers);
        IngressosComponent = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return IngressosComponent = _classThis;
})();
exports.IngressosComponent = IngressosComponent;
